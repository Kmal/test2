...
static const ui_menu_item_t s_main_items[] = {
    ...
    UI_ITEM("BLE Status", UI_SCREEN_CONNECT_BLUETOOTH, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_NONE, 0),
...
static const ui_menu_item_t s_settings_items[] = {
    UI_ITEM("Display", UI_SCREEN_SETTINGS_DISPLAY, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Device", UI_SCREEN_SETTINGS_DEVICE, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Connectivity", UI_SCREEN_SETTINGS_CONNECTIVITY, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Automation", UI_SCREEN_SETTINGS_AUTOMATION, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Hardware", UI_SCREEN_SETTINGS_HARDWARE, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Maintenance", UI_SCREEN_SETTINGS_MAINTENANCE, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("About", UI_SCREEN_SETTINGS_ABOUT, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
};

static const ui_menu_item_t s_settings_display_items[] = {
    UI_ITEM("Edit Timezone", UI_SCREEN_SETTINGS_DISPLAY, UI_ACTION_SETTINGS_EDIT_TIMEZONE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
};

static const ui_menu_item_t s_settings_device_items[] = {
    UI_ITEM("Device Status", UI_SCREEN_SETTINGS_DEVICE_STATUS, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("About", UI_SCREEN_SETTINGS_ABOUT, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
};
...
static const ui_menu_item_t s_settings_hardware_items[] = {
    UI_ITEM("Power Status", UI_SCREEN_SETTINGS_HARDWARE, UI_ACTION_NONE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("Buttons", UI_SCREEN_SETTINGS_HARDWARE, UI_ACTION_NONE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
    UI_ITEM("LCD", UI_SCREEN_SETTINGS_HARDWARE, UI_ACTION_NONE, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
};

static const ui_menu_item_t s_settings_maintenance_items[] = {
    UI_ITEM("Restart Device", UI_SCREEN_SETTINGS_MAINTENANCE, UI_ACTION_SETTINGS_RESTART, UI_FIELD_NONE, UI_FLOW_SETTINGS, 0),
};
...
static const ui_screen_def_t s_screens[UI_SCREEN_COUNT] = {
    ...
    [UI_SCREEN_CONNECT_BLUETOOTH] = { UI_SCREEN_CONNECT_BLUETOOTH, UI_SCREEN_MAIN, "BLE Status", s_connect_bluetooth_items, ARRAY_COUNT(s_connect_bluetooth_items), UI_FLOW_BLUETOOTH },
    ...
    [UI_SCREEN_SETTINGS_DISPLAY] = { UI_SCREEN_SETTINGS_DISPLAY, UI_SCREEN_SETTINGS, "Display", s_settings_display_items, ARRAY_COUNT(s_settings_display_items), UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_DEVICE] = { UI_SCREEN_SETTINGS_DEVICE, UI_SCREEN_SETTINGS, "Device", s_settings_device_items, ARRAY_COUNT(s_settings_device_items), UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_DEVICE_STATUS] = { UI_SCREEN_SETTINGS_DEVICE_STATUS, UI_SCREEN_SETTINGS_DEVICE, "Device Status", NULL, 0u, UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_CONNECTIVITY] = { UI_SCREEN_SETTINGS_CONNECTIVITY, UI_SCREEN_SETTINGS, "Connectivity", s_settings_connectivity_items, ARRAY_COUNT(s_settings_connectivity_items), UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_AUTOMATION] = { UI_SCREEN_SETTINGS_AUTOMATION, UI_SCREEN_SETTINGS, "Automation", s_settings_automation_items, ARRAY_COUNT(s_settings_automation_items), UI_FLOW_AUTOMATION },
    [UI_SCREEN_SETTINGS_HARDWARE] = { UI_SCREEN_SETTINGS_HARDWARE, UI_SCREEN_SETTINGS, "Hardware", s_settings_hardware_items, ARRAY_COUNT(s_settings_hardware_items), UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_MAINTENANCE] = { UI_SCREEN_SETTINGS_MAINTENANCE, UI_SCREEN_SETTINGS, "Maintenance", s_settings_maintenance_items, ARRAY_COUNT(s_settings_maintenance_items), UI_FLOW_SETTINGS },
    [UI_SCREEN_SETTINGS_ABOUT] = { UI_SCREEN_SETTINGS_ABOUT, UI_SCREEN_SETTINGS, "About", NULL, 0u, UI_FLOW_SETTINGS },
};
