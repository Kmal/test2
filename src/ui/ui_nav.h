...
typedef enum {
    ...
    UI_SCREEN_SETTINGS,
    UI_SCREEN_SETTINGS_DISPLAY,
    UI_SCREEN_SETTINGS_DEVICE,
    UI_SCREEN_SETTINGS_DEVICE_STATUS,
    UI_SCREEN_SETTINGS_CONNECTIVITY,
    UI_SCREEN_SETTINGS_AUTOMATION,
    UI_SCREEN_SETTINGS_HARDWARE,
    UI_SCREEN_SETTINGS_MAINTENANCE,
    UI_SCREEN_SETTINGS_ABOUT,
...
typedef enum {
    ...
    UI_ACTION_SETTINGS_EDIT_TIMEZONE,
    UI_ACTION_SETTINGS_TOGGLE_WEB_UI_SERVICE,
    UI_ACTION_SETTINGS_RESTART
} ui_action_t;
