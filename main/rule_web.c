...
static const char s_rule_setup_page[] =
    ...
    "<label>AP Name <input id=\"ap_ssid\" maxlength=\"32\" autocomplete=\"off\" autocapitalize=\"none\" autocorrect=\"off\" spellcheck=\"false\"></label>"
    "<label>AP Password <input id=\"ap_password\" type=\"password\" maxlength=\"63\" autocomplete=\"off\" autocapitalize=\"none\" autocorrect=\"off\" spellcheck=\"false\"></label>"
    ...
    "<label>Threshold <input id=\"threshold\" value=\"true\" autocomplete=\"off\" autocapitalize=\"none\" autocorrect=\"off\" spellcheck=\"false\"></label>"
    ...
    "<label>HTTP URL <input id=\"http_url\" size=\"48\" placeholder=\"https://example.invalid/hook\" autocomplete=\"off\" autocapitalize=\"none\" autocorrect=\"off\" spellcheck=\"false\"></label>"
    "<label>HTTP bearer token <input id=\"http_bearer_token\" type=\"password\" autocomplete=\"off\" autocapitalize=\"none\" autocorrect=\"off\" spellcheck=\"false\"></label></section>"
