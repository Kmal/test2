...
static const ui_menu_item_t s_config_wifi_mode_items[] = {
    ...
    UI_ITEM("Hidden / Manual SSID", UI_SCREEN_CONFIG_WIFI_MANUAL, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_CONFIG_WIFI, 0),
};

static const ui_menu_item_t s_config_wifi_scan_items[] = {
    UI_ITEM("Select SSID", UI_SCREEN_CONFIG_WIFI_SELECT_SSID, UI_ACTION_WIFI_SELECT_SSID, UI_FIELD_WIFI_SSID, UI_FLOW_CONFIG_WIFI, 0),
};

static const ui_menu_item_t s_config_wifi_selected_items[] = {
    UI_ITEM("Enter Password", UI_SCREEN_CONFIG_WIFI_ENTER_PASSWORD, UI_ACTION_WIFI_ENTER_PASSWORD, UI_FIELD_WIFI_PASSWORD, UI_FLOW_CONFIG_WIFI, 0),
    UI_ITEM("Connect and Save", UI_SCREEN_CONFIG_WIFI_CONNECT_SAVE, UI_ACTION_WIFI_CONNECT_AND_SAVE, UI_FIELD_NONE, UI_FLOW_CONFIG_WIFI, 0),
};

static const ui_menu_item_t s_config_wifi_manual_items[] = {
    UI_ITEM("Enter SSID", UI_SCREEN_CONFIG_WIFI_ENTER_SSID, UI_ACTION_WIFI_ENTER_SSID, UI_FIELD_WIFI_SSID, UI_FLOW_CONFIG_WIFI, 0),
    UI_ITEM("Enter Password", UI_SCREEN_CONFIG_WIFI_MANUAL_PASSWORD, UI_ACTION_WIFI_ENTER_PASSWORD, UI_FIELD_WIFI_PASSWORD, UI_FLOW_CONFIG_WIFI, 0),
    UI_ITEM("Connect and Save", UI_SCREEN_CONFIG_WIFI_MANUAL_CONNECT_SAVE, UI_ACTION_WIFI_CONNECT_AND_SAVE, UI_FIELD_NONE, UI_FLOW_CONFIG_WIFI, 0),
};
...
static const ui_menu_item_t s_connect_wifi_items[] = {
    ...
    UI_ITEM("Hidden / Manual SSID", UI_SCREEN_CONNECT_WIFI_MANUAL, UI_ACTION_NAVIGATE, UI_FIELD_NONE, UI_FLOW_CONNECT_WIFI, 0),
};

static const ui_menu_item_t s_connect_wifi_scan_items[] = {
    UI_ITEM("Select SSID", UI_SCREEN_CONNECT_WIFI_SELECT_SSID, UI_ACTION_WIFI_SELECT_SSID, UI_FIELD_WIFI_SSID, UI_FLOW_CONNECT_WIFI, 0),
};

static const ui_menu_item_t s_connect_wifi_selected_items[] = {
    UI_ITEM("Enter Password", UI_SCREEN_CONNECT_WIFI_ENTER_PASSWORD, UI_ACTION_WIFI_ENTER_PASSWORD, UI_FIELD_WIFI_PASSWORD, UI_FLOW_CONNECT_WIFI, 0),
    UI_ITEM("Connect and Save", UI_SCREEN_CONNECT_WIFI_CONNECT_SAVE, UI_ACTION_WIFI_CONNECT_AND_SAVE, UI_FIELD_NONE, UI_FLOW_CONNECT_WIFI, 0),
};

static const ui_menu_item_t s_connect_wifi_manual_items[] = {
    UI_ITEM("Enter SSID", UI_SCREEN_CONNECT_WIFI_ENTER_SSID, UI_ACTION_WIFI_ENTER_SSID, UI_FIELD_WIFI_SSID, UI_FLOW_CONNECT_WIFI, 0),
    UI_ITEM("Enter Password", UI_SCREEN_CONNECT_WIFI_MANUAL_PASSWORD, UI_ACTION_WIFI_ENTER_PASSWORD, UI_FIELD_WIFI_PASSWORD, UI_FLOW_CONNECT_WIFI, 0),
    UI_ITEM("Connect and Save", UI_SCREEN_CONNECT_WIFI_MANUAL_CONNECT_SAVE, UI_ACTION_WIFI_CONNECT_AND_SAVE, UI_FIELD_NONE, UI_FLOW_CONNECT_WIFI, 0),
};
...
static const ui_menu_item_t s_automation_1_trigger_items[] = {
    UI_ITEM_FLAGS("Sound RMS", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 0),
    UI_ITEM_FLAGS("Sound Peak", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 1),
    UI_ITEM_FLAGS("Key1 Short", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 2),
    UI_ITEM_FLAGS("Key2 Short", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 3),
    UI_ITEM_FLAGS("BLE Connected", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 4),
    UI_ITEM_FLAGS("Wi-Fi Connected", UI_SCREEN_AUTOMATION_1, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 0, 5),
};
...
static const ui_menu_item_t s_automation_2_trigger_items[] = {
    UI_ITEM_FLAGS("Sound RMS", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 0),
    UI_ITEM_FLAGS("Sound Peak", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 1),
    UI_ITEM_FLAGS("Key1 Short", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 2),
    UI_ITEM_FLAGS("Key2 Short", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 3),
    UI_ITEM_FLAGS("BLE Connected", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 4),
    UI_ITEM_FLAGS("Wi-Fi Connected", UI_SCREEN_AUTOMATION_2, UI_ACTION_AUTOMATION_EDIT_TRIGGER, UI_FIELD_AUTOMATION_TRIGGER, UI_FLOW_AUTOMATION, 1, 5),
};
...
static const ui_screen_def_t s_screens[UI_SCREEN_COUNT] = {
    ...
    [UI_SCREEN_CONFIG_WIFI_SCAN] = { UI_SCREEN_CONFIG_WIFI_SCAN, UI_SCREEN_CONFIG_WIFI_MODE, "Scan Nearby Wi-Fi", s_config_wifi_scan_items, ARRAY_COUNT(s_config_wifi_scan_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_SELECT_SSID] = { UI_SCREEN_CONFIG_WIFI_SELECT_SSID, UI_SCREEN_CONFIG_WIFI_SCAN, "Select SSID", s_config_wifi_selected_items, ARRAY_COUNT(s_config_wifi_selected_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_ENTER_PASSWORD] = { UI_SCREEN_CONFIG_WIFI_ENTER_PASSWORD, UI_SCREEN_CONFIG_WIFI_SELECT_SSID, "Enter Password", s_config_wifi_selected_items, ARRAY_COUNT(s_config_wifi_selected_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_CONNECT_SAVE] = { UI_SCREEN_CONFIG_WIFI_CONNECT_SAVE, UI_SCREEN_CONFIG_WIFI_SELECT_SSID, "Connect and Save", s_config_wifi_selected_items, ARRAY_COUNT(s_config_wifi_selected_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_MANUAL] = { UI_SCREEN_CONFIG_WIFI_MANUAL, UI_SCREEN_CONFIG_WIFI_MODE, "Hidden / Manual SSID", s_config_wifi_manual_items, ARRAY_COUNT(s_config_wifi_manual_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_ENTER_SSID] = { UI_SCREEN_CONFIG_WIFI_ENTER_SSID, UI_SCREEN_CONFIG_WIFI_MANUAL, "Enter SSID", s_config_wifi_manual_items, ARRAY_COUNT(s_config_wifi_manual_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_MANUAL_PASSWORD] = { UI_SCREEN_CONFIG_WIFI_MANUAL_PASSWORD, UI_SCREEN_CONFIG_WIFI_MANUAL, "Enter Password", s_config_wifi_manual_items, ARRAY_COUNT(s_config_wifi_manual_items), UI_FLOW_CONFIG_WIFI },
    [UI_SCREEN_CONFIG_WIFI_MANUAL_CONNECT_SAVE] = { UI_SCREEN_CONFIG_WIFI_MANUAL_CONNECT_SAVE, UI_SCREEN_CONFIG_WIFI_MANUAL, "Connect and Save", s_config_wifi_manual_items, ARRAY_COUNT(s_config_wifi_manual_items), UI_FLOW_CONFIG_WIFI },
    ...
    [UI_SCREEN_CONNECT_WIFI_SCAN] = { UI_SCREEN_CONNECT_WIFI_SCAN, UI_SCREEN_CONNECT_WIFI, "Scan Nearby Wi-Fi", s_connect_wifi_scan_items, ARRAY_COUNT(s_connect_wifi_scan_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_SELECT_SSID] = { UI_SCREEN_CONNECT_WIFI_SELECT_SSID, UI_SCREEN_CONNECT_WIFI_SCAN, "Select SSID", s_connect_wifi_selected_items, ARRAY_COUNT(s_connect_wifi_selected_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_ENTER_PASSWORD] = { UI_SCREEN_CONNECT_WIFI_ENTER_PASSWORD, UI_SCREEN_CONNECT_WIFI_SELECT_SSID, "Enter Password", s_connect_wifi_selected_items, ARRAY_COUNT(s_connect_wifi_selected_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_CONNECT_SAVE] = { UI_SCREEN_CONNECT_WIFI_CONNECT_SAVE, UI_SCREEN_CONNECT_WIFI_SELECT_SSID, "Connect and Save", s_connect_wifi_selected_items, ARRAY_COUNT(s_connect_wifi_selected_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_MANUAL] = { UI_SCREEN_CONNECT_WIFI_MANUAL, UI_SCREEN_CONNECT_WIFI, "Hidden / Manual SSID", s_connect_wifi_manual_items, ARRAY_COUNT(s_connect_wifi_manual_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_ENTER_SSID] = { UI_SCREEN_CONNECT_WIFI_ENTER_SSID, UI_SCREEN_CONNECT_WIFI_MANUAL, "Enter SSID", s_connect_wifi_manual_items, ARRAY_COUNT(s_connect_wifi_manual_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_MANUAL_PASSWORD] = { UI_SCREEN_CONNECT_WIFI_MANUAL_PASSWORD, UI_SCREEN_CONNECT_WIFI_MANUAL, "Enter Password", s_connect_wifi_manual_items, ARRAY_COUNT(s_connect_wifi_manual_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_WIFI_MANUAL_CONNECT_SAVE] = { UI_SCREEN_CONNECT_WIFI_MANUAL_CONNECT_SAVE, UI_SCREEN_CONNECT_WIFI_MANUAL, "Connect and Save", s_connect_wifi_manual_items, ARRAY_COUNT(s_connect_wifi_manual_items), UI_FLOW_CONNECT_WIFI },
    [UI_SCREEN_CONNECT_BLUETOOTH] = { UI_SCREEN_CONNECT_BLUETOOTH, UI_SCREEN_MAIN, "Connect to Bluetooth", s_connect_bluetooth_items, ARRAY_COUNT(s_connect_bluetooth_items), UI_FLOW_BLUETOOTH },
